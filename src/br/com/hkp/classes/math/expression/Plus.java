/*
arquivo Plus.java criado a partir de 11 de agosto de 2018
*/
package br.com.hkp.classes.math.expression;

/**
 * Esta classe cria um objeto Plus.PLUS para representar a operacao de soma,
...
final class Plus implements Operation
{
    ...
    */
    private static final int PRIORITY_LEVEL = LEVEL_1;
    /*
    ...
    *   dessa classe. O objeto PLUS eh a unica instancia dessa classe e esta
    *   incluido no array private OPERATIONS da classe OperatorsMap, que 
    *   lista todos os objetos do tipo Operation.
    ...
    *   OperatorsMap, TokenAnalisis e da interface Operation
    ...
    /**
     * Realiza a operacao de adicao e retorna o resultado.
          * 
   ...
   /**
     ...
     * operandos. Operadores prefixos e posfixos devem ser unarios. Funcoes 
     * podem ter quaisquer numero de operandos. No caso do parenteses
