/*
arquivo Minus.java criado a partir de 11 de agosto de 2018
*/
package br.com.hkp.classes.math.expression;

/**
 * Esta classe cria um objeto Minus.MINUS para realizar a operacao de subtracao,
...
final class Minus implements Operation
{
    ...
    *   dessa classe. O objeto MINUS eh a unica instancia dessa classe e esta
    ...
    *   OperatorsMap, TokenAnalisis e da interface Operation
     ...
     * Esse operador retorna args[1] subtraido de args[0]. 
     * 
