/*
arquivo Sqr.java criado a partir de 21 de fevereiro de 2019
*/
package br.com.hkp.classes.math.expression;

/**
 * Esta classe cria um objeto Sqr.SQR para realizar a operacao radiciacao 
 * quadrada de um operando, quando da avaliacao ou equacionamento de uma 
 * expressoa matematica na forma infixa ou posfixa.
 * <p>
 ...
 * @since 1.0
 */
final class Sqr implements Operation
{
    /*
    ...
    */
    private static final String IDENTIFIER = "sqr";
    /*
    ...
    */
    static final Sqr SQR = new Sqr();
    
    /*[01]----------------------------------------------------------------------
    *   Construtor privado da classe impede que sejam criados objetos dessa
    *   dessa classe. O objeto SQR eh a unica instancia dessa classe e esta
    ...
    *   OperatorsMap, TokenAnalisis e da interface Operation
     ...
     * Esse operador retorna a raiz quadrada do argumento
     * 
     * @param args o operando da raiz quadrada
     *
     * @return  raiz de args[0] como double
     */
    /*[02]----------------------------------------------------------------------
    *              Realiza a operacao e retorna o resultado
    ...
    {
        if (args[0] < 0)
            throw new MathException(MathException.MSG01 + IDENTIFIER);
        return Math.sqrt(args[0]);
    }//fim de op()
    
    /**
     * Retorna a String que representa o operador "sqr"
     * 
     * @return  "sqr"
     */
    /*[03]----------------------------------------------------------------------
