/*
arquivo Mult.java criado a partir de 11 de agosto de 2018
*/
package br.com.hkp.classes.math.expression;

/**
 * Esta classe cria um objeto Mult.MULT para realizar a operacao de produto,
 ...
 * @since 1.0
 */
final class Mult implements Operation
{
    /*
    ...
    */
    static final Mult MULT = new Mult();
    
     /*[01]----------------------------------------------------------------------
    *   Construtor privado da classe impede que sejam criados objetos dessa
    *   dessa classe. O objeto MULT eh a unica instancia dessa classe e esta
    ...
    *   OperatorsMap, TokenAnalisis e da interface Operation
     ...
     * Esse operador retorna o produto destes argumentos. 
     * 
     * @param args os argumentos que serao multiplicados
     * 
     * @return (args[0] * args[1]) como doubles 
     */
    /*[02]----------------------------------------------------------------------
