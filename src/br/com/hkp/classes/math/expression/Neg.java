/*
arquivo Neg.java criado a partir de 11 de agosto de 2018
*/
package br.com.hkp.classes.math.expression;

/**
 * Esta classe cria um objeto Neg.NEG para realizar a operacao de inverter o
 * sinal de um operando, quando da avaliacao ou equacionamento de uma expressoa 
 ...
 * @since 1.0
 */
final class Neg implements Operation
{
    /*
    ...
    */
    private static final int PRIORITY_LEVEL = LEVEL_PREFIX_POSFIX;
    /*
    ...
    */
    static final Neg NEG = new Neg();
    
    /*[01]----------------------------------------------------------------------
    *   Construtor privado da classe impede que sejam criados objetos dessa
    *   dessa classe. O objeto NEG eh a unica instancia dessa classe e esta
    ...
    *   OperatorsMap, TokenAnalisis e da interface Operation
     ...
     * Esse operador retorna o valor multiplicado por -1
     * 
     * @param args os operandos da operacao de subtracao
     * 
     * @return  args[0] * (-1)  como double
     */
    /*[02]----------------------------------------------------------------------
    ...
    *              Retorna a String que identifica do operador
     ...
     * expressao infixa
     * 
     * @return Operation.LEVEL_PREFIX_POSFIX
     */
    /*[04]----------------------------------------------------------------------
